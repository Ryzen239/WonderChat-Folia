package me.ryzen23.wonderlandschat.utils.item;
...
public class ItemBuilder {
    ...
    public static ItemStack fromSection(ConfigurationSection section) {
        ...
        configurableValues.cellSet().forEach(cell -> {
            ...
            if (section.contains(id)) {
                try {
                    method.invoke((Object)builder, section.getClass().getMethod(mName, String.class).invoke((Object)section, id));
                }
    ...
    private static String getSkullHash(ItemStack item) {
        try {
            ...
            if (propertyMap.containsKey((Object)"textures") && (iterator = propertyMap.get((Object)"textures").iterator()).hasNext()) {
    ...
    public ItemStack build() {
        ...
        if (this.skullHash != null) {
            ...
            propertyMap.put((Object)"textures", (Object)new Property("textures", this.skullHash));
            SkullMeta skullMeta = (SkullMeta)meta;
            try {
    ...
    static {
        try {
            configurableValues.put((Object)"data", (Object)ItemBuilder.class.getMethod("data", Integer.TYPE), (Object)"getInt");
            configurableValues.put((Object)"name", (Object)ItemBuilder.class.getMethod("name", String.class), (Object)"getString");
            configurableValues.put((Object)"amount", (Object)ItemBuilder.class.getMethod("amount", Integer.TYPE), (Object)"getInt");
            configurableValues.put((Object)"lore", (Object)ItemBuilder.class.getMethod("lore", List.class), (Object)"getStringList");
            configurableValues.put((Object)"glow", (Object)ItemBuilder.class.getMethod("glowing", Boolean.TYPE), (Object)"getBoolean");
            configurableValues.put((Object)"enchants", (Object)ItemBuilder.class.getMethod("enchants", ConfigurationSection.class), (Object)"getConfigurationSection");
            configurableValues.put((Object)"flags", (Object)ItemBuilder.class.getMethod("flags", List.class), (Object)"getStringList");
            configurableValues.put((Object)"skull-hash", (Object)ItemBuilder.class.getMethod("skullHash", String.class), (Object)"getString");
            configurableValues.put((Object)"skull", (Object)ItemBuilder.class.getMethod("skull", String.class), (Object)"getString");
        }
