...
extends Renderable {
    ...
    public void select(int index) {
        ...
        if (index == this.selectedIndex && !this.allowDeselect) {
            return;
        }
        Object oldSelection = this.selectedIndex == -1 ? null : ((Option)this.options.get(this.selectedIndex)).value;
        Object newSelection = ((Option)this.options.get(index)).value;
        this.onSelectionChange.accept(oldSelection, newSelection);
