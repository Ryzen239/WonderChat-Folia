package me.ryzen23.wonderlandschat.utils.schedulerutil;
...
public class ScheduledTask {
    ...
    public ScheduledTask start() {
        ...
        int n = this.data.isSync() ? (this.data.isRepeating() ? scheduler.scheduleSyncRepeatingTask((Plugin)this.plugin, this.data.getRunnable(), this.data.getTicks(), this.data.getTicks()) : scheduler.scheduleSyncDelayedTask((Plugin)this.plugin, this.data.getRunnable(), this.data.getTicks())) : (this.id = this.data.isRepeating() ? scheduler.runTaskTimerAsynchronously((Plugin)this.plugin, this.data.getRunnable(), this.data.getTicks(), this.data.getTicks()).getTaskId() : scheduler.runTaskLaterAsynchronously((Plugin)this.plugin, this.data.getRunnable(), this.data.getTicks()).getTaskId());
